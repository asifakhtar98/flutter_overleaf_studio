...
mixin _$ProjectState {
 ...
 List<ProjectFile> get files; String? get activeFilePath; String? get mainFilePath;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectState&&const DeepCollectionEquality().equals(other.files, files)&&(identical(other.activeFilePath, activeFilePath) || other.activeFilePath == activeFilePath)&&(identical(other.mainFilePath, mainFilePath) || other.mainFilePath == mainFilePath));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(files),activeFilePath,mainFilePath);

@override
String toString() {
  return 'ProjectState(files: $files, activeFilePath: $activeFilePath, mainFilePath: $mainFilePath)';
}
...
/// Create a copy of ProjectState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? files = null,Object? activeFilePath = freezed,Object? mainFilePath = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ProjectFile> files,  String? activeFilePath,  String? mainFilePath)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectState() when $default != null:
return $default(_that.files,_that.activeFilePath,_that.mainFilePath);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ProjectFile> files,  String? activeFilePath,  String? mainFilePath)  $default,) {final _that = this;
switch (_that) {
case _ProjectState():
return $default(_that.files,_that.activeFilePath,_that.mainFilePath);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ProjectFile> files,  String? activeFilePath,  String? mainFilePath)?  $default,) {final _that = this;
switch (_that) {
case _ProjectState() when $default != null:
return $default(_that.files,_that.activeFilePath,_that.mainFilePath);case _:
  return null;
...
class _ProjectState implements ProjectState {
  const _ProjectState({final  List<ProjectFile> files = const [], this.activeFilePath, this.mainFilePath}): _files = files;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProjectState&&const DeepCollectionEquality().equals(other._files, _files)&&(identical(other.activeFilePath, activeFilePath) || other.activeFilePath == activeFilePath)&&(identical(other.mainFilePath, mainFilePath) || other.mainFilePath == mainFilePath));
}
...
/// Create a copy of ProjectState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? files = null,Object? activeFilePath = freezed,Object? mainFilePath = freezed,}) {
