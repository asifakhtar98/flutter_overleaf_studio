...
mixin _$ProjectState {
 ...
 List<ProjectFile> get files; String? get activeFilePath; String? get mainFilePath; bool get isImporting; bool get isExporting; String? get importError;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(files),activeFilePath,mainFilePath,isImporting,isExporting,importError);

@override
String toString() {
  return 'ProjectState(files: $files, activeFilePath: $activeFilePath, mainFilePath: $mainFilePath, isImporting: $isImporting, isExporting: $isExporting, importError: $importError)';
}
...
@useResult
$Res call({
 List<ProjectFile> files, String? activeFilePath, String? mainFilePath, bool isImporting, bool isExporting, String? importError
});
...
/// Create a copy of ProjectState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? files = null,Object? activeFilePath = freezed,Object? mainFilePath = freezed,Object? isImporting = null,Object? isExporting = null,Object? importError = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<ProjectFile> files,  String? activeFilePath,  String? mainFilePath,  bool isImporting,  bool isExporting,  String? importError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectState() when $default != null:
return $default(_that.files,_that.activeFilePath,_that.mainFilePath,_that.isImporting,_that.isExporting,_that.importError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<ProjectFile> files,  String? activeFilePath,  String? mainFilePath,  bool isImporting,  bool isExporting,  String? importError)  $default,) {final _that = this;
switch (_that) {
case _ProjectState():
return $default(_that.files,_that.activeFilePath,_that.mainFilePath,_that.isImporting,_that.isExporting,_that.importError);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<ProjectFile> files,  String? activeFilePath,  String? mainFilePath,  bool isImporting,  bool isExporting,  String? importError)?  $default,) {final _that = this;
switch (_that) {
case _ProjectState() when $default != null:
return $default(_that.files,_that.activeFilePath,_that.mainFilePath,_that.isImporting,_that.isExporting,_that.importError);case _:
  return null;
...
class _ProjectState implements ProjectState {
  const _ProjectState({final  List<ProjectFile> files = const [], this.activeFilePath, this.mainFilePath, this.isImporting = false, this.isExporting = false, this.importError}): _files = files;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_files),activeFilePath,mainFilePath,isImporting,isExporting,importError);
...
/// Create a copy of ProjectState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? files = null,Object? activeFilePath = freezed,Object? mainFilePath = freezed,Object? isImporting = null,Object? isExporting = null,Object? importError = freezed,}) {
